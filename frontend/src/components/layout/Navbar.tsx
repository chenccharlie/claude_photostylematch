              ...
              <div className="flex">
                <div className="flex flex-shrink-0 items-center">
                  <Link href="/" className="flex items-center">
                    <span className="text-xl font-bold text-primary-500">PhotoStyleMatch</span>
                  </Link>
                </div>
              ...
              <div className="hidden sm:ml-6 sm:flex sm:items-center">
                {isLoading ? (
                  ...
                  <div>
                    ...
                    <Link
                      href="/auth/register"
                      className="inline-flex items-center rounded-md bg-primary-500 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-primary-600"
                    >
                      Sign up
                    </Link>
                  </div>
